...
import static com.londonappbrewery.bitcointicker.BitcoinDataModel.fromJson;
    ...
    private void letsDoSomeNetworking(String url) {
        ...
        client.get(url, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                Log.d("Bitcoin", "JSON: " + response.toString() + statusCode);
     ...
     private void updateUI(BitcoinDataModel bitcoinDataModel){
         mPriceTextView.setText(bitcoinDataModel.getAnswer());
     }
